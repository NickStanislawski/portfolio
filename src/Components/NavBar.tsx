...
const NavBar = () => {
  ...
  // UPDATED SCROLL LOGIC (SPLIT THE DIFFERENCE)
  ...
  const mobileMenuStyles: React.CSSProperties = {
    ...
    backgroundColor: isMobile ? Colors.white || "#ffffff" : "transparent",
  ...
  const mobileLinksStyles: React.CSSProperties = {
    ...s.navLinks,
    display: "flex",
    flexDirection: isMobile ? "column" : "row",
  ...
  return (
    <>
      <nav
        style={{
          ...s.nav,
          boxShadow: scrolled ? "0 2px 10px rgba(0,0,0,0.07)" : "none",
          position: "fixed",
          top: 0,
          left: 0,
          right: 0,
      ...
      >
        ...
        >
          Nick Stanislawski<span style={{ color: Colors.blue }}></span>
        </a>
